...
public class Ripoux extends Humain implements HorsLaLoi {
	...
	public Ripoux(String nom, String prenom, String boisson, int nbDames, int miseAPrix, boolean enPrison) {
	...
	public Ripoux(String nom, String prenom, String boisson, int nbDames, boolean enPrison) {
		super(nom, prenom, boisson);
		this.look = "mechant";
		this.nbDames = nbDames;
		this.miseAPrix = 100;
	...
	public Ripoux(String nom, String prenom, int nbDames, int miseAPrix, boolean enPrison) {
	...
	public Ripoux(String nom, String prenom, int nbDames, boolean enPrison) {
		super(nom, prenom, "tord-boyaux");
		this.look = "mechant";
		this.nbDames = nbDames;
		this.miseAPrix = 100;
	...
	public Ripoux(String nom, String prenom, String boisson, int nbDames, int miseAPrix) {
		super(nom, prenom, boisson);
		this.look = "mechant";
		this.nbDames = nbDames;
		this.miseAPrix = miseAPrix;
	...
	public Ripoux(String nom, String prenom, String boisson, int nbDames) {
		super(nom, prenom, boisson);
		this.look = "mechant";
		this.nbDames = nbDames;
		this.miseAPrix = 100;
	...
	public Ripoux(String nom, String prenom, int nbDames, int miseAPrix) {
		super(nom, prenom, "tord-boyaux");
		this.look = "mechant";
		this.nbDames = nbDames;
		this.miseAPrix = miseAPrix;
	...
	public Ripoux(String nom, String prenom, int nbDames) {
		super(nom, prenom, "tord-boyaux");
		this.look = "mechant";
		this.nbDames = nbDames;
		this.miseAPrix = 100;
	...
	public Ripoux(String nom, String prenom, String boisson) {
		super(nom, prenom, boisson);
		this.look = "mechant";
		this.nbDames = 0;
		this.miseAPrix = 100;
	...
	public Ripoux(String nom, String prenom) {
		super(nom, prenom, "tord-boyaux");
		this.look = "mechant";
		this.nbDames = 0;
		this.miseAPrix = 100;
